...
private extension AppManager.TextStyle{
    ...
    var appAttributes : AppManager.TextAttributes {
        ...
        case .statusBar:
			return AppManager.TextAttributes(font: UIFont(name: "AvenirNext-DemiBold", size: 16.0)!, color: UIColor(hexString:"#FFFFFF")!, backgroundColor: UIColor.white)
        case .title:
        ...
        case .button:
            return AppManager.TextAttributes(font: UIFont.systemFont(ofSize: 18), color: UIColor.systemBlue, backgroundColor: UIColor.clear)
        case .menu:
